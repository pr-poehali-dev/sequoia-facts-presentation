...
const slides = [
  ...
  },
  {
    ...
    content: '',
    features: [
      { icon: 'ArrowUp', label: 'Высота', value: 'До 115 метров', detail: 'Выше 35-этажного дома, статуи Свободы' },
      { icon: 'Circle', label: 'Диаметр ствола', value: 'До 11 метров', detail: 'Через крупнейшие деревья прорубали туннели для автомобилей' },
      { icon: 'Scale', label: 'Вес', value: 'До 2500 тонн', detail: 'Эквивалент 400 слонов или 15 синих китов' },
      { icon: 'Calendar', label: 'Возраст', value: 'До 3500 лет', detail: 'Они росли, когда строились египетские пирамиды' },
      { icon: 'Trees', label: 'Объём древесины', value: 'До 1487 м³', detail: 'Хватит построить 40 домов' },
      { icon: 'Ruler', label: 'Скорость роста', value: '60 см в год', detail: 'Самый быстрый рост среди всех деревьев' }
    ]
  },
  {
    id: 2,
